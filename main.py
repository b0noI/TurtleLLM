...
if __name__ == '__main__':
    ...
    vocab_size = 128
    input_tokens_max_length = 8
    model = tmodel.TurtleLlmModel(vocab_size, 512, 4, ff_dim=2048, debug=False, input_tokens_max_length=input_tokens_max_length)
    params = model.init(rngkey, jax.numpy.ones((input_tokens_max_length, input_tokens_max_length), dtype = jnp.int8))
    ...
    while iter_n < 50:
        for input_text in texts:
            ...
            batches = tllm_data.split_ascii_numpy_array_into_batches(ascii_text, input_tokens_max_length)
